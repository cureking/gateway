...
public class IWarningServiceImpl implements IWarningService {
    ...
    public ServerResponse inclinationInitCheck(){
        ...
        ServerResponse checkResponse = iInclinationDealInitService.listCheckedData(INCLINATIONINIT_LIMIT, INCLINATIONINIT_DURATION, lastOringinId, INCLINATIONINIT_COUNT_LIMIT);
