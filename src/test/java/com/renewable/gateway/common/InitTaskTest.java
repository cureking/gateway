...
/* 
try { 
   Method method = InitTask.getClass().getMethod("getPhysicalRegister"); 
...
//    assertNotNull(RedisPoolUtil.get(Const.SENSOR_REGISTER_PREFIX+"List"));
/* 
try { 
   Method method = InitTask.getClass().getMethod("initLocalRegister"); 
   method.setAccessible(true); 
   method.invoke(<Object>, <Parameters>); 
} catch(NoSuchMethodException e) { 
} catch(IllegalAccessException e) { 
